...
class CourseAdmin(admin.ModelAdmin):
    list_display = ['course_code', 'course_name', 'department', 'semester', 'is_active', 'quiz_count', 'question_count']
...
class QuizAdmin(admin.ModelAdmin):
    list_display = ['quiz_name', 'course', 'total_marks', 'is_active', 'question_count']
